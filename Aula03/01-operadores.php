    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <?php
                    ...
                    echo "<br>Porque " . '$a' . " vale $a <br>";
                    echo "e" . ' $b' . " vale $b" . '<br>'; 
                    echo 'Primeiro parêntesis: 30 (que é o valor do $a) + 3 == 33<br>';
                    echo 'Segundo parêntesis: 5 x 4 (que é o valor do $b) == 20<br>';
                    echo "Agora a multiplicação: 33 * 4 == 132<br>";
                    echo "Agora a soma: 132 + 20 que é  <br>";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($a >= $b) {
                                echo "True (Comparação verdadeira)";
                            } else {
                                echo "False (Comparação falsa)";
                            }
                            ?> 
                        </td>
                        <td>$a recebe 10 e $b recebe 5</td>
